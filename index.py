...
#Simple Gesture
for i in tqdm(range(0, 100), desc = "Loading Students Data"):
    sleep(.2)
...
def contact():
    mess._show(title='Connect with us', message="Please contact us on : 'temp@gmail.com' ")
...
def TrainImages():
    ...
    ctypes.windll.user32.MessageBoxW(0, "Profile saved Succesfully", "System")
...
filename = PhotoImage(file = "Images//bg_2.png")
...
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="black"  ,bg="white"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
quitWindow.place(x=30, y=450)
my_button = tk.Button(frame1 ,text = "Download", command = data, fg="black"  ,bg="white"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
my_button.place(x=30, y=500)
